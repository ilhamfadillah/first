  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <!-- charts menu -->
        @include('sidebar-charts')

        <!-- ui elements menu -->
        @include('sidebar-uielements')

        <!-- form menu -->
        @include('sidebar-forms')

        <!-- tables menu -->
        @include('sidebar-tables')

        <!-- calendar menu -->
        @include('sidebar-calendar')

        <!-- mailbox menu -->
        @include('sidebar-mailbox')

        <!-- examples menu -->
        @include('sidebar-examples')

        <!-- multilevel menu -->
        @include('sidebar-multilevel')
